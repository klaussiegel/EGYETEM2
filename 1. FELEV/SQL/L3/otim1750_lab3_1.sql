...
WHERE Kocsmak.KocsmaID=Arak.KocsmaID AND Arak.ItalID=Italok.ItalID AND Italok.TipusID=ItalTipusok.TipusID AND ItalTipusok.TipusNev='vodka' AND Kocsmak.KocsmaID NOT IN (
...
WHERE Baratok.BaratID=Kedvencek.BaratID AND Kocsmak.KocsmaID=Kedvencek.KocsmaID AND
( Kocsmak.Nev='Frederico Sawley' AND Kocsmak.Nev!='Hedwiga Ledbetter' AND Kocsmak.Nev!='Daisy Geeve')
...
SELECT DISTINCT Kocsmak.Nev FROM Kocsmak,Arak,Italok,ItalTipusok
WHERE Kocsmak.KocsmaID=Arak.KocsmaID AND Arak.ItalID=Italok.ItalID AND Italok.TipusID=ItalTipusok.TipusID AND ItalTipusok.TipusNev='vodka'
